...
function registerPollSubmitButton() {
    ...
    document.getElementById("submitbutton").addEventListener("click", quickpoll)
...
async function quickpoll() {
    ...
    // TODO: add form fields for solution / explanation
    let pollFormData = {"topic": question, "options": [], "solution": -1, "explanation": "..."}
